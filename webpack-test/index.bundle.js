...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, exports) {
	  ...
	  Backbone.sync = function(method, model, options) {
	    if (typeof console != 'undefined') {
	      console.log('bmc edition of Backbone has no default sync');
	    }
	  };
